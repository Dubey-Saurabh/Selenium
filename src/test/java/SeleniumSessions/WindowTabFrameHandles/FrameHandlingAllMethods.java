...
public class FrameHandlingAllMethods {
    ...
    public static void main(String[] args) {
        ...
        driver.switchTo().frame("classFrame").findElement(By.xpath("//*[contains(text(),'compact1')]")).click();
        driver.navigate().back();
        driver.switchTo().frame("packageFrame").findElement(By.xpath("//*[contains(text(),'AbstractDocument')]")).click();
...
//        driver.switchTo().parentFrame();
       ...
       /* //nested frames
        driver.switchTo().frame(driver.findElement(By.xpath("//*[contains(@src,'frame_3.html')]"))
        .findElement(By.xpath("//p[contains(text(),'iframe inside frame:')]/following-sibling::iframe")));
